...
<head>
    ...
    <title>Clinical Note Analysis</title>
    ...
    <section id="features" class="card-section">
        ...
        <div class="card-grid">
            ...
            <div class="card">
                ...
                <button class="btn" onclick="window.location.href='index.php?url=nlp/index'">
                    Start Analysis
                </button>
            </div>
            ...
            <div class="card">
                ...
                <button class="btn" onclick="window.location.href='<?php echo $isLoggedIn ? 'index.php?url=history/index' : 'index.php?url=login/index'; ?>'">
                    View History
                </button>
            </div>
        </div>
